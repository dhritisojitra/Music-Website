...
export const Useref = () => {
    ...
    const Clicked = ()=>{
        ...
        inputEle.current.style .background = "blue"       //accessing the dom element
        ...
        <>
            ...
            <div className='bg-blue-100 min-h-screen p-10 flex flex-col items-center'>
                ...
                <div className=' flex items-center flex-col w-full max-w-3xl bg-white p-6 rounded-lg shadow-md m-2'>
                    <h3>Case 1: Using to prevent re-rendering during state change</h3>
                ...
                <div className=' flex items-center flex-col w-full max-w-3xl bg-white p-6 rounded-lg shadow-md m-2'>
                    <h3>Case 2: Accessing DOM elements</h3>
